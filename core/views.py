...
from .models import Item, OrderItem, Order, Address, Payment, Comment, Coupon, Refund, UserProfile
...
class SearchView(View):
    def get(self, *args, **kwargs):
        ...
        if 'product_name' in self.request.GET:
            ...
            return render(self.request, 'listings/search.html', context)
        else:
            message.warning(self.request, 'please enter valid product name')
            return redirect('/')
...
class CheckoutView(View):
    def get(self, *args, **kwargs):
        try:
            ...
            return render(self.request, "listings/checkout.html", context)
...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            return render(self.request, "listings/payment.html", context)
        else:
            messages.warning(
...
def MyOrderView(request):
    if request.method == "GET":
        ...
        return render(request, 'listings/orders.html', context)


def WriteReviewsView(request, ref_code):
    if request.method == "GET":
        order = Order.objects.filter(user=request.user, ref_code=ref_code)
...
class MyReturnsView(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, 'listings/returns.html', context)
    ...
    if request.user.is_authenticated:
        if request.method == "GET":
            try:
                ...
                return render(request, 'listings/order_summary.html', context)
            except ObjectDoesNotExist:
...
def add_to_cart(request, slug):
    if request.user.is_authenticated:
        ...
        if order_qs.exists():
            ...
            ordered_date = today + datetime.timedelta(days = 7) 
...
class RequestRefundView(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, "listings/request_refund.html", context)
